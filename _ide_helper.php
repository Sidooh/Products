 ...
 */
     ...
     * @method static SentMessage|null plain(string $view, array $data, $callback)
     * @method static SentMessage|null html(string $html, $callback)
...
')
    ...
    namespace Spatie\LaravelIgnition\Facades {use Spatie\FlareClient\array;use Spatie\FlareClient\classuse; Spatie\FlareClient\FlareMiddleware\FlareMiddleware;
            /**
     *
     *
...
namespace  {
            use ;use Illuminate\Contracts\Pagination\CursorPaginator;use Illuminate\Contracts\Pagination\LengthAwarePaginator;use Illuminate\Contracts\Pagination\Paginator;use Illuminate\Contracts\Support\Arrayable;use Illuminate\Database\Eloquent\Model;use Illuminate\Database\Eloquent\ModelNotFoundException;use Illuminate\Database\Eloquent\RelationNotFoundException;use Illuminate\Database\Eloquent\Relations\MorphTo;use Illuminate\Database\Eloquent\Relations\Relation;use Illuminate\Database\Eloquent\Scope;use Illuminate\Database\Eloquent\TUnlessReturnType;use Illuminate\Database\Eloquent\TWhenReturnType;use Illuminate\Database\MultipleRecordsFoundException;use Illuminate\Database\Query\Builder;use Illuminate\Database\Query\Expression;use Illuminate\Database\Query\Grammars\Grammar;use Illuminate\Database\Query\never;use Illuminate\Database\Query\Processors\Processor;use Illuminate\Database\RecordsNotFoundException;use Illuminate\Pagination\Cursor;use Illuminate\Support\Collection;use Illuminate\Support\LazyCollection;class App extends \Illuminate\Support\Facades\App {}
